...
CAMERA_SMOOTH_SPEED = 10.0       # выше = быстрее камера "догоняет" цель
FADE_POPUP_IN_DURATION = 0.18    # сек, открытие паузы/события
FADE_POPUP_OUT_DURATION = 0.15   # сек, закрытие паузы/события
VICTORY_FADE_DURATION = 0.6      # сек, появление экрана победы